...
void motorLCD()
{
    static unsigned char row0[] = "F 00:00 1-0 2-0 ";
    static unsigned char row1[] = "3-0 4-0 5-0 6-0 ";
   ...
   static unsigned char pos = 0; 
    ...
    { 
        ...
        case 1:
            ...
            row0[LLETRA] = getCurrentUserLastLetter();
            row0[HORA_0] = getHora_0();
            row0[HORA_1] = getHora_1();
            row0[MINUT_0] = getMinut_0();
            row0[MINUT_1] = getMinut_1();
            row0[CONFIG_0] = getLedConfigFromCurrentUser(0, 1);
            row0[CONFIG_1] = getLedConfigFromCurrentUser(1, 1);
            
            row1[CONFIG_2] = getLedConfigFromCurrentUser(2, 1);
            row1[CONFIG_3] = getLedConfigFromCurrentUser(3, 1);
            row1[CONFIG_4] = getLedConfigFromCurrentUser(4, 1);
            row1[CONFIG_5] = getLedConfigFromCurrentUser(5, 1);  
        ...
        case 3:
            ...
            break;
//        case 4:
//            if (TI_GetTics(Timer) >= 100)
//                stateLCD = 0;
//            break;
        case 5:
            if (LcPutString(empty)) {
                stateLCD++;
                LcGotoXY (0,1);
            }
            break;
